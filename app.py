...
Delivery_Freq.update_layout(xaxis_type='category')
...
Takeout_Freq = px.pie(
                            df,
                                ...
                                labels = df["Takeout_Freq"].value_counts().index,
...
Bought_Takeout = px.pie(
                            df,
                                ...
                                labels = df["Bought_Takeout"].value_counts().index,
...
Bring_Back = px.pie(
                df,
                    ...
                    labels = df["Bring_Back"].value_counts().index,
